...
export const contentModal={formText:'Ви успішно відправили форму, тепер відкрийте подарункову коробку',falseBox:'На жаль, ви нічого не виграли',trueBox:'Вітаємо! Ви виграли пилосос дайсон',falseForm:'Заповніть, будь ласка, форму',boxEnd:'У вас закінчилися спроби',formEnd:'Ви вже надіслали відповіді на запитання'}
